...
class _MapLocationPickerState extends State<MapLocationPicker> {
                    ...
                    children: [
                      ListTile(
                        ...
                        trailing: TextButton(
                          ...
                          onPressed: () async {
                            double? latitude = _geocodingResult?.geometry.location.lat;
                            double? longitude = _geocodingResult?.geometry.location.lng;

                            // Store the values in the LocationData class
                            LocakionData.latitude = latitude;
                            LocakionData.longitude = longitude;
  ...
  void _getCurrentLocation() async {
    try {
      ...
      _initialPosition = latLng;
      final controller = await _controller.future;
      initialUserLoc.latitude=position.latitude;
      initialUserLoc.longitude=position.longitude;
      controller.animateCamera(
        CameraUpdate.newCameraPosition(
          cameraPosition(),
        ),
