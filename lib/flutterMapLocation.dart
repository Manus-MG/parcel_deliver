  ...
  Widget build(BuildContext context) {
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                              onTap: () {
                                ...
                                controller.move(
                                    LatLng(locationList[index].latitude,
    ...
    Widget viewLocationName() {
      return widget.customFooter != null
          ? widget.customFooter!(
              LocationResult(latitude, longitude, locationName), controller)
          : Container(
              ...
              child: Column(
                children: [
                  ...
                  widget.customButton != null
                      ...
                      : ElevatedButton(
                          onPressed: () {
                            widget.onPicked(LocationResult(
              ...
              child: TextButton(
                onPressed: () {
                  if (controller.camera.zoom < 17) {
                    controller.move(LatLng(latitude, longitude),
    ...
    return FlutterMap(
      ...
      children: [
        TileLayer(
          urlTemplate: mapType == MapType.normal
